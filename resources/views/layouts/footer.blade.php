            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-brand-card p-4 rounded-3 mb-3 bg-white border-0 shadow-sm">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <img src="{{ asset('logo.webp') }}" alt="Logo PT Readymix Beton Indonesia" width="135" height="45" loading="lazy" class="footer-brand-logo img-fluid" style="max-height: 45px; width: auto;">
                    </div>
