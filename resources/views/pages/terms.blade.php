...
<div class="terms-wrapper">
    <div class="terms-container">
        ...
        <p class="terms-text">
            Website ini berfungsi sebagai media informasi produk & layanan pengadaan beton cor (Ready Mix). Segala bentuk transaksi, negosiasi harga, dan kesepakatan volume kubikasi ($m^3$) dilakukan secara langsung dengan menghubungi nomor telepon atau informasi kontak resmi yang tertera pada website ini.
        </p>
